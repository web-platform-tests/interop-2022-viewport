...
const getVisualViewPortValues = ({ clampOffsets = false, resizeDimensions = false }) => {
	let { width, height, widthOrig = null, heightOrig = null, scale, offsetTop, offsetLeft, offsetTopOrig = null, offsetLeftOrig = null, pageLeft, pageTop, pageLeftOrig = null, pageTopOrig = null } = window.visualViewport;
...
const getLayoutViewportValues = () => {
	...
	const { width, height } = layoutViewport.getBoundingClientRect();
...
const getICBValuesByMeasuringTheRootElement = () => {
...
export { getICBValuesByMeasuringTheRootElement };
